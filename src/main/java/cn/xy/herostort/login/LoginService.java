package cn.xy.herostort.login;

import cn.xy.herostort.MySqlSessionFactory;
import cn.xy.herostort.async.AsyncOperationProcessor;
import cn.xy.herostort.async.IAsyncOperation;
import cn.xy.herostort.login.db.IUserDao;
import cn.xy.herostort.login.db.UserEntity;
...
public final class LoginService {
     ...
     * 日志服务
     */
    static private final Logger LOGGER = LogManager.getLogger(LoginService.class);
